export default function CenteredHero({ textContent = {} }) {
  const {
    heading = "Build Beautiful Websites Faster",
    subheading = "Create stunning, responsive websites with our component library. Mix and match to build your perfect site.",
    ...
    <section className="py-20 bg-white dark:bg-gray-900">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <a href="#" className="px-6 py-3 rounded-md bg-primary text-white font-medium">{buttonText[0]}</a>
