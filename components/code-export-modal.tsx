...
`
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between">
                <div className="mb-6 md:mb-0 md:mr-8">
                  <h2 className="text-3xl font-bold mb-4">${
                    textContent.heading || "Take Your Website to the Next Level"
                  }</h2>
  ...
  const subheading = "${
    textContent.subheading || "We provide the tools you need to build websites faster and more efficiently."
  }"
  ...
  const subheading = "${
    textContent.subheading || "Don't just take our word for it. See what our users have to say about our platform."
  }"
  ...
  const subheading = "${
    textContent.subheading || "We have plans for businesses of all sizes. Select the one that works best for you."
  }"
  const plans = ${JSON.stringify(
    textContent.plans || [
      {
  ...
  const subheading = "${
    textContent.subheading || "Join thousands of users who are already building beautiful websites with our platform."
  }"
  ...
  const subheading = "${
    textContent.subheading || "Start building with our component library today and see the difference."
  }"
  ...
  const companyDescription = "${
    textContent.companyDescription || "Building the future of web development with component-based design."
  }"
...
`
  ...
  const getComponentHTML = (category, componentId) => {
    ...
    // Convert React JSX to HTML with custom text
    switch (componentId) {
      case "simple-header":
      ...
      <div class="container mx-auto px-4 py-4">
        <div class="flex justify-between items-center">
          ...
          <div class="flex items-center space-x-3">
            <button class="px-4 py-2 rounded-md border border-gray-300 dark:border-gray-700">${
              textContent.buttonText?.[0] || "Login"
            }</button>
      ...
      <div class="container mx-auto px-4">
        <div class="flex justify-between items-center py-2 border-b border-gray-100 dark:border-gray-800">
          <div class="text-sm text-gray-600 dark:text-gray-400">Contact: ${
            textContent.contactInfo || "contact@example.com"
          }</div>
          <div class="flex space-x-4 text-sm">
            ${(textContent.topMenuItems || ["Support", "FAQ"])
              .map(
                (item) =>
                  `<a href="#" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">${item}</a>`,
              )
              .join("\n            ")}
          </div>
        </div>
      ...
      <div class="container mx-auto px-4 text-center">
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-4">
          <button class="px-6 py-3 rounded-md bg-blue-600 text-white font-medium">${
            textContent.buttonText?.[0] || "Get Started"
          }</button>
      ...
      <div class="container mx-auto px-4 relative z-20 text-center text-white">
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-4">
          <button class="px-6 py-3 rounded-md bg-white text-gray-900 font-medium">${
            textContent.buttonText?.[0] || "Get Started"
          }</button>
          <button class="px-6 py-3 rounded-md border border-white font-medium">${
            textContent.buttonText?.[1] || "View Components"
          }</button>
        </div>
      </div>
      ...
      <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ${(textContent.features || ["Feature 1", "Feature 2", "Feature 3", "Feature 4", "Feature 5", "Feature 6"])
            .map(
              (feature, index) => `<div class="p-6 border border-gray-200 dark:border-gray-800 rounded-lg">
        ...
        <div class="flex flex-col lg:flex-row items-center">
          <div class="lg:w-1/2 mb-10 lg:mb-0">
            ...
            <ul class="space-y-4">
              ${(textContent.features || ["Feature 1", "Feature 2", "Feature 3", "Feature 4"])
                .map(
                  (feature, index) => `<li class="flex items-start">
                <div class="mr-4 mt-1 w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center text-white">
                  ✓
                </div>
                <div>
      ...
      <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ${(textContent.features || ["Feature 1", "Feature 2", "Feature 3", "Feature 4"])
            .map(
              (feature, index) => `<div class="text-center">
      ...
      <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ${(
            ...
            .map(
              (testimonial, index) => `<div class="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-sm">
      ...
      <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ${(
            ...
            .map(
              (plan, index) => `<div
            class="border ${index === 1 ? "border-blue-600" : "border-gray-200 dark:border-gray-800"} rounded-lg p-8"
          >
            ...
            <ul class="space-y-3 mb-8">
              ${plan.features
                .map(
                  (feature) => `<li class="flex items-center">
      ...
      <div class="container mx-auto px-4">
        ...
        <div class="flex flex-col lg:flex-row gap-8 max-w-6xl mx-auto">
          ${(
            ...
            .map(
              (plan, index) => `<div
            class="flex-1 bg-white dark:bg-gray-900 rounded-lg shadow-sm overflow-hidden ${
              index === 1 ? "lg:-mt-4 lg:-mb-4 lg:border-2 lg:border-blue-600" : ""
            }"
          >
            ${
              index === 1
                ? '<div class="bg-blue-600 text-white text-center py-2 text-sm font-medium">Most Popular</div>'
                : ""
            }
            <div class="p-8">
          ...
          <div>
            ...
            <div class="flex space-x-4">
              ${(textContent.socialLinks || ["FB", "TW", "IG", "LI"])
                .map(
                  (link) =>
                    `<a href="#" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">${link}</a>`,
                )
                .join("\n              ")}
            </div>
          </div>
          ${(
            ...
            <ul class="space-y-2">
              ${column.links
                .map(
                  (link) =>
                    `<li><a href="#" class="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">${link}</a></li>`,
                )
                .join("\n              ")}
            </ul>
          </div>`,
        ...
        <div class="flex flex-col items-center">
          ...
          <div class="flex space-x-6 mb-8">
            ${(textContent.socialLinks || ["FB", "TW", "IG", "LI"])
              .map(
                (link) =>
                  `<a href="#" class="w-10 h-10 bg-gray-200 dark:bg-gray-800 rounded-full flex items-center justify-center">${link}</a>`,
              )
              .join("\n            ")}
          </div>
