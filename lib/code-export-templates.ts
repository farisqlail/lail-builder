import { hexToRgb } from "@/lib/code-export-utils"
...
export interface ComponentTextContent {
  companyName?: string
  menuItems?: string[]
...
export const getComponentSourceCode = (
  ...
  const colorStyleBg = componentColor
    ? `style={{ backgroundColor: "rgba(${hexToRgb(componentColor)}, 0.15)" }}`
    : ""
    ...
    case "simple-header":
      return `<header className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800">
          <div className="container mx-auto px-4 py-4 flex justify-between items-center">
            <div className="font-bold text-xl" ${colorStyleText}>${textContent.companyName || "Company Name"}</div>
    ...
    case "image-hero":
      return `<section className="relative h-[500px] flex items-center justify-center overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-20 text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <button className="px-6 py-3 rounded-md bg-white text-gray-900 font-medium" ${colorStyleText}>${
                textContent.buttonText?.[0] || "Get Started"
              }</button>
          ...
          <div className="container mx-auto px-4 py-12">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              ${(
                ...
                .map(
                  (column) => `<div>
                <h3 className="font-semibold text-lg mb-4" ${colorStyleText}>${column.title}</h3>
      ...
      return `<footer className="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">
          <div className="container mx-auto px-4 py-12">
            <div className="flex flex-col items-center">
              <div className="font-bold text-2xl mb-4" ${colorStyleText}>${textContent.companyName || "Company Name"}</div>
              ...
              <div className="flex space-x-6 mb-8">
                ${(textContent.socialLinks || ["FB", "TW", "IG", "LI"])
                  .map(
                    (link) =>
                      `<a href="#" className="w-10 h-10 bg-gray-200 dark:bg-gray-800 rounded-full flex items-center justify-center" ${colorStyleBg}><span ${colorStyleText}>${link}</span></a>`,
                  )
                  .join("\n                ")}
              </div>
...
export const getFullComponentCode = (category: string, componentId: string, customTextContent: Record<string, ComponentTextContent>, componentColor = "#3b82f6") => {
  // Get the custom text content for this component
  const textContent = customTextContent[`${category}-${componentId}`] || {}
  const colorStyle = componentColor ? `style={{ backgroundColor: "${componentColor}" }}` : ""
  ...
  return (
    <header className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        <div className="font-bold text-xl" ${colorStyleText}>{companyName}</div>
        <nav className="hidden md:flex space-x-6">
        ...
        <div className="flex items-center space-x-3">
          <button className="px-4 py-2 rounded-md bg-blue-600 text-white" ${colorStyle}>{buttonText}</button>
        </div>
      </div>
    </header>
  )
      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-3">
            ...
            <button className="px-4 py-2 rounded-md bg-blue-600 text-white" ${colorStyle}>{buttonText[1]}</button>
          </div>
        </div>
      </div>
    </header>
  ...
  return (
    <section className="py-20 bg-white dark:bg-gray-900">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <button className="px-6 py-3 rounded-md bg-blue-600 text-white font-medium" ${colorStyle}>{buttonText[0]}</button>
          <button className="px-6 py-3 rounded-md border border-gray-300 dark:border-gray-700 font-medium">
            {buttonText[1]}
          </button>
        </div>
  ...
  return (
    <section className="relative h-[500px] flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-20 text-center text-white">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <button className="px-6 py-3 rounded-md bg-white text-gray-900 font-medium" ${colorStyleText}>{buttonText[0]}</button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {plans.map((plan, index) => (
            <div
              key={index}
              className={\`border \${index === 1 ? "border-blue-600" : "border-gray-200 dark:border-gray-800"} rounded-lg p-8\`}
              ${componentColor ? `style={index === 1 ? { borderColor: "${componentColor}" } : {}}` : ""}
            >
              <h3 className="text-2xl font-bold mb-4">{plan.name}</h3>
              <div className="mb-4">
                <span className="text-4xl font-bold">\${plan.price}</span>
              ...
              <button
                ...
                ${componentColor ? `style={index === 1 ? { backgroundColor: "${componentColor}" } : {}}` : ""}
              >
                {plan.buttonText}
              </button>
            </div>
      ...
      <div className="container mx-auto px-4">
        <div className="bg-blue-50 dark:bg-blue-900/20 rounded-2xl p-8 md:p-12" ${colorStyleBg}>
          <div className="flex flex-col md:flex-row md:items-center justify-between">
            ...
            <div className="flex-shrink-0">
              <button className="px-6 py-3 rounded-md bg-blue-600 text-white font-medium" ${colorStyle}>{buttonText}</button>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <footer className="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <div className="font-bold text-xl mb-4" ${colorStyleText}>{companyName}</div>
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              {companyDescription}
            </p>
            <div className="flex space-x-4">
  ...
  return (
    <footer className="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">
      <div className="container mx-auto px-4 py-12">
        <div className="flex flex-col items-center">
          <div className="font-bold text-2xl mb-4" ${colorStyleText}>{companyName}</div>
          <div className="flex space-x-8 mb-8">
            {menuItems.map((item, index) => (
              <a key={index} href="#" className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
                {item}
...
export const getComponentHTML = (category: string, componentId: string, customTextContent: Record<string, ComponentTextContent>, componentColor = "#3b82f6") => {
  // Get custom text content for this component
  const textContent = customTextContent[`${category}-${componentId}`] || {}
  const colorStyle = componentColor ? `style="background-color: ${componentColor}"` : ""
  const colorStyleBg = componentColor
    ? `style="background-color: rgba(${hexToRgb(componentColor)}, 0.15)"`
    : ""
  const colorStyleText = componentColor ? `style="color: ${componentColor}"` : ""
  const colorStyleBorder = componentColor ? `style="border-color: ${componentColor}"` : ""
  ...
  switch (componentId) {
      ...
      return `<header class="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800">
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div class="flex items-center space-x-3">
            <button class="px-4 py-2 rounded-md bg-blue-600 text-white" ${colorStyle}>${textContent.buttonText || "Sign Up"}</button>
          </div>
        </div>
      </header>`
        ...
        <div class="container mx-auto px-4 py-4">
          <div class="flex justify-between items-center">
            <div class="flex items-center space-x-2">
              <div class="w-8 h-8 bg-blue-600 rounded-md" ${colorStyle}></div>
              <div class="font-bold text-xl">${textContent.companyName || "Company Name"}</div>
            </div>
            ...
            <div class="flex items-center space-x-3">
              ...
              <button class="px-4 py-2 rounded-md bg-blue-600 text-white" ${colorStyle}>${textContent.buttonText?.[1] || "Sign Up"}</button>
            </div>
          </div>
        </div>
      </header>`
      ...
      return `<header class="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800">
        <div class="container mx-auto px-4">
          ...
          <div class="flex justify-between items-center py-4">
            <div class="flex items-center space-x-2">
              <div class="w-10 h-10 bg-blue-600 rounded-full" ${colorStyle}></div>
              <div class="font-bold text-xl" ${colorStyleText}>${textContent.companyName || "Company Name"}</div>
            </div>
            <nav class="hidden md:flex space-x-8">
              ${(textContent.menuItems || ["Home", "Products", "Services", "About", "Blog", "Contact"])
                .map(item => `<a href="#" class="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">${item}</a>`)
            ...
            <div class="flex items-center space-x-3">
              <button class="px-4 py-2 rounded-md border border-gray-300 dark:border-gray-700">${textContent.buttonText?.[0] || "Login"}</button>
              <button class="px-4 py-2 rounded-md bg-blue-600 text-white" ${colorStyle}>${textContent.buttonText?.[1] || "Get Started"}</button>
            </div>
          </div>
        </div>
      </header>`
      ...
      return `<section class="py-20 bg-white dark:bg-gray-900">
        <div class="container mx-auto px-4 text-center">
          ...
          <div class="flex flex-col sm:flex-row justify-center gap-4">
            <button class="px-6 py-3 rounded-md bg-blue-600 text-white font-medium" ${colorStyle}>${textContent.buttonText?.[0] || "Get Started"}</button>
          ...
          <div class="flex flex-col md:flex-row items-center">
            <div class="md:w-1/2 mb-10 md:mb-0 md:pr-10">
              ...
              <div class="flex flex-col sm:flex-row gap-4">
                <button class="px-6 py-3 rounded-md bg-blue-600 text-white font-medium" ${colorStyle}>${textContent.buttonText?.[0] || "Start Building"}</button>
    ...
    case "image-hero":
      return `<section class="relative h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <div class="container mx-auto px-4 relative z-20 text-center text-white">
          ...
          <div class="flex flex-col sm:flex-row justify-center gap-4">
            <button class="px-6 py-3 rounded-md bg-white text-gray-900 font-medium" ${colorStyleText}>${textContent.buttonText?.[0] || "Get Started"}</button>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ${(textContent.features || ["Feature 1", "Feature 2", "Feature 3", "Feature 4", "Feature 5", "Feature 6"])
              .map((feature, index) => `<div class="p-6 border border-gray-200 dark:border-gray-800 rounded-lg">
                <div class="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center mb-4" ${colorStyleBg}>
                  <div class="w-6 h-6 bg-blue-600 rounded" ${colorStyle}></div>
                </div>
              ...
              <ul class="space-y-4">
                ${(textContent.features || ["Feature 1", "Feature 2", "Feature 3", "Feature 4"])
                  .map((feature, index) => `<li class="flex items-start">
                    <div class="mr-4 mt-1 w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center text-white" ${colorStyle}>✓</div>
                    <div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ${(textContent.features || ["Feature 1", "Feature 2", "Feature 3", "Feature 4"])
              .map((feature, index) => `<div class="text-center">
                <div class="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4" ${colorStyleBg}>
                  <div class="w-8 h-8 bg-blue-600 rounded-full" ${colorStyle}></div>
                </div>
                <h3 class="text-xl font-semibold mb-2">${feature}</h3>
                <p class="text-gray-600 dark:text-gray-400">${textContent.featureDescriptions?.[index] || "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor."}</p>
              </div>`)
      ...
      return `<section class="py-16 bg-white dark:bg-gray-900">
        <div class="container mx-auto px-4">
          <div class="max-w-4xl mx-auto text-center">
            <div class="text-5xl text-blue-600 mb-6" ${colorStyleText}>"</div>
        ...
        <div class="container mx-auto px-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ${(textContent.plans || [
              ...
              .map(plan => `<div class="border ${plan.name === "Pro" ? "border-blue-600" : "border-gray-200 dark:border-gray-800"} rounded-lg p-8" ${plan.name === "Pro" ? colorStyleBorder : ""}>
                ...
                <button class="w-full py-2 rounded-md ${plan.name === "Pro" ? "bg-blue-600 text-white" : "border border-gray-300 dark:border-gray-700"}" ${plan.name === "Pro" ? colorStyle : ""}>${plan.buttonText}</button>
              </div>`).join("\n")}
          </div>
        </div>
      </section>`
        ...
        <div class="container mx-auto px-4">
          ...
          <div class="flex flex-col lg:flex-row gap-8 max-w-6xl mx-auto">
            ${(textContent.plans || [
              ...
              .map((plan, index) => `<div class="flex-1 bg-white dark:bg-gray-900 rounded-lg shadow-sm overflow-hidden ${index === 1 ? "lg:-mt-4 lg:-mb-4 lg:border-2 lg:border-blue-600" : ""}" ${index === 1 ? colorStyleBorder : ""}>
                ${index === 1 ? `<div class="bg-blue-600 text-white text-center py-2 text-sm font-medium" ${colorStyle}>Most Popular</div>` : ""}
                <div class="p-8">
                  ...
                  <button class="w-full py-3 rounded-md ${index === 1 ? "bg-blue-600 text-white" : "border border-gray-300 dark:border-gray-700"}" ${index === 1 ? colorStyle : ""}>${plan.buttonText}</button>
                </div>
              </div>`).join("\n")}
          </div>
        </div>
      ...
      return `<section class="py-16 bg-white dark:bg-gray-900">
        <div class="container mx-auto px-4">
          <div class="text-center max-w-3xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4">
              <button class="px-6 py-3 rounded-md bg-blue-600 text-white font-medium" ${colorStyle}>${textContent.buttonText?.[0] || "Start Building Now"}</button>
    ...
    case "boxed-cta":
      return `<section class="py-16 bg-white dark:bg-gray-900">
        <div class="container mx-auto px-4">
          <div class="bg-blue-50 dark:bg-blue-900/20 rounded-2xl p-8 md:p-12" ${colorStyleBg}>
            <div class="flex flex-col md:flex-row md:items-center justify-between">
              ...
              <div class="flex-shrink-0">
                <button class="px-6 py-3 rounded-md bg-blue-600 text-white font-medium" ${colorStyle}>${textContent.buttonText || "Get Started"}</button>
              </div>
            </div>
          </div>
        </div>
      ...
      return `<footer class="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">
        <div class="container mx-auto px-4 py-12">
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div>
              <div class="font-bold text-xl mb-4" ${colorStyleText}>${textContent.companyName || "Company Name"}</div>
            ...
            ${(textContent.columns || [
              ...
              .map(column => `<div>
                <h3 class="font-semibold text-lg mb-4" ${colorStyleText}>${column.title}</h3>
                <ul class="space-y-2">
                  ${column.links
      ...
      return `<footer class="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">
        <div class="container mx-auto px-4 py-12">
          <div class="flex flex-col items-center">
            <div class="font-bold text-2xl mb-4" ${colorStyleText}>${textContent.companyName || "Company Name"}</div>
            ...
            <div class="flex space-x-6 mb-8">
              ${(textContent.socialLinks || ["FB", "TW", "IG", "LI"])
                .map(link => `<a href="#" class="w-10 h-10 bg-gray-200 dark:bg-gray-800 rounded-full flex items-center justify-center" ${colorStyleBg}><span ${colorStyleText}>${link}</span></a>`)
                .join("\n")}
            </div>
