...
export default function LandingPage() {
    ...
    return (
        <div className="min-h-screen">
            ...
            {/* Pricing Section */}
            {/* <section id="pricing" className="py-16 bg-white dark:bg-gray-900" data-aos="fade-up">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-12">
            ...
            <footer className="bg-gray-900 text-white py-12" data-aos="fade-up">
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        <div>
                            <h3 className="text-xl font-bold mb-4">Lail Builder</h3>
                    ...
                    <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
                        <p>© {new Date().getFullYear()} Laildev. All rights reserved.</p>
                    </div>
                </div>
            </footer>
        </div>
